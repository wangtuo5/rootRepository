	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>				
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='../user/bussupdate.jsp'  class=channel_title>业务修改输入</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="bussform" method="post" action="bussupdate">
			<table border="0"  cellspacing='0' cellpadding='0' width="50%" height="80%">
			<%
				String ss = request.getParameter("id");
				ResultSet rs=JDBCUtil.getConnection().createStatement().executeQuery("select * from userservices where id="+ss);
				rs.next();
			 %>
			<tr>
			...
			<tr>
				...
				<td align="left" valign="top"><input type="text" name="name" value="<%=rs.getString(3)%>" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right" valign="top">业务登录密码：</td>				
				<td align="left"  valign="top"><input type="text" name="password" value="<%=rs.getString(4)%>" style="WIDTH:170px"></td>
				
			</tr>
			<tr>
				<td align="right" valign="top">实验室IP：</td>
				<td align="left" valign="top"><input type="text" name="labip" value="<%=rs.getString(5)%>" style="width:170px;"></td>	
			</tr>			
			<tr>
			...
			<tr>
				...
				<td align="left" valign="top">
					<select name="priceid" style="WIDTH:170px"><option value="1" selected>资费</option></select>
