	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='../fee/feebrforupd.jpg'  class=channel_title>资费修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<s:form action="feebrforupd" theme="simple">
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>资费ID</td><td>资费名称</td><td>基费</td><td>月租费用</td><td>资费说明</td><td>修改操作</td>
				</tr>
						<% 
						...
						<tr>
							...
							<td>
								<a href="feeupdate.jsp?id=<%=rs.getInt(1)%>">修改</a>
							</td>
						</tr>
