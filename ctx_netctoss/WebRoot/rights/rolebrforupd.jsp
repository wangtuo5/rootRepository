	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='../rights/index.do?method=browseRole'  class=channel_title>角色浏览</a>
				</td>
			</tr>
		</table>
		</td>
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>角色ID</td><td>角色名称</td><td>角色拥有的权限</td><td>修改</td>
				</tr>
						<% ResultSet rs=JDBCUtil.getConnection().createStatement().executeQuery("select * from rolerights");
							while(rs.next()){
					...
					<tr>
						...
						<td>
							<%
								ResultSet rs1=JDBCUtil.getConnection().createStatement().executeQuery("select * from rights where id="+rs.getInt(3) );
								rs1.next();
								out.print(rs1.getString(2));
							%>						
						</td>
						<td>
							<a href="roleupdate.jsp?id=<%=rs.getInt(1)%>" >修改</a>
						</td>
					</tr>
				<%}; %>
			</table>
