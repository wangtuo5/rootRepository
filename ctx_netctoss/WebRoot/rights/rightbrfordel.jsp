	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='../rights/rightbrfordel.htm'  class=channel_title>权限删除</a>
				</td>
			</tr>
		</table>
		</td>
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>权限ID</td><td>权限名称</td><td>权限URL</td><td>权限所在模块</td><td>权限操作名称</td><td>删除操作</td>
				</tr>
					...
					<tr>
						...
						<td>
							<a href="rightdelete.jsp?id=<%=rs.getInt(1)%>">删除</a>
						</td>
					</tr>
