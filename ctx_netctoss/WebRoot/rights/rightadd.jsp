	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='../rights/rightadd.htm'  class=channel_title>权限增加</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<s:form name="rightform" method="post" action="rightadd" theme="simple">
			<table border="0"  cellspacing='0' cellpadding='0' width="60%" height="80%">
			<tr>
				<td align="right" >权限名称：
				</td><td >
					<s:textfield  name="name" value="" style="WIDTH:170px"/>					
				</td>
			...
			<tr>
				...
				<td  valign="top">
					<s:textfield name="url" value="" style="WIDTH:170px"/>					
				</td>
			</tr>
			<tr>
