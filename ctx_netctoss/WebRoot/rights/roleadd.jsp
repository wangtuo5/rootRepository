	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='roleadd.htm'  class=channel_title>角色增加</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<br/><br/>
		<s:form action="roleadd" theme="simple">
			<table border="0"  cellspacing='0' cellpadding='0' width="80%">
			<tr>
				<td>角色名称：</td>
				<td align="left"><s:textfield name="name" value="1" style="WIDTH:170px"/>(填入角色编号1，暂时就一个)</td>
			</tr>
			
			<tr>
				<td >拥有权限：</td>
				<td align="left"><s:textfield  name="tt" value="1" style="WIDTH:170px"/>(填入权限编号1到28)</td>						
			</tr>
			<tr>
				<td  align="center" colspan="2"><s:submit value="增加"/>&nbsp;&nbsp;&nbsp;&nbsp;<s:reset value="取消"/> </td>
				<td>
			</tr>
			</table>
		</s:form>			
