	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='../reckon/reckon.jsp'  class=channel_title>帐单查询</a>
				</td>
			</tr>
		</table>
		</td>
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<th>年</th><th>月</th><th>用户名</th><th>服务器IP</th><th>费用</th><th>明细</th>
				</tr>
					<% 
    			...
    			<tr>
    				...
    				<td><input type="button" value="明细" onclick="window.location='../reckon/reckondetail.jsp?id=<%=rs.getInt(1)%>'"/></td>
    			</tr>
