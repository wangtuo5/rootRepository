			...
			<table border='0' cellspacing='0' cellpadding='0'>
				<tr>
					...
					<td height='31'
						...
						<img src="../images/sy_2_18.jpg" border="0">
						<a href='../account/acctmonthdetail.jsp' class=channel_title>帐务-月明细查询</a>
					</td>
				</tr>
			</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<td align="left" height='31'
			...
			月:
			<input type="text" name="month" maxlength="20" value="<%=rs.getString(8).split("-")[1]%>" readonly="readonly" style="WIDTH: 80px">
		</td>
	</tr>
