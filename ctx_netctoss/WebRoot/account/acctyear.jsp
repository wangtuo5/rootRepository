		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<td height='31' background='../images/ctitle_bak_fcenter.jpg'>
						...
						<img src="../images/sy_2_18.jpg" border="0">
						<a href='../account/acctyear.jsp'  class=channel_title>帐务管理-年查询</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="accountform" method="post" action="acctyear">
			查询条件：&nbsp;&nbsp;
			...
			<table cellspacing='0' cellpadding='0' width="100%" border="1">
					...
					<% 
						...
						ResultSet rs=JDBCUtil.getConnection().createStatement().executeQuery("select * from userservices ");
							while(rs.next()){
								if(rs.getString(8).split("-")[0].equalsIgnoreCase(years)){
					 %>
						<tr>
							<td>
								<%= rs.getString(5)%>
							...
							<td>
								<a href="../account/acctyeardetail.jsp?id=<%= rs.getInt(1)%>">详细清单</a>
						</tr>
