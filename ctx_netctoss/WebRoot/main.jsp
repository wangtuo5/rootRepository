<%@page import="com.opensymphony.xwork2.ActionContext" contentType="text/html;charset=utf-8"%>
	...
	<tr>
		...
		<table width='100%' border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<a href="main.jsp" class="cl">首页</a><span class="STYLE4">|</span>
				
					<a href="rights/index.jsp" class="cl">权限管理</a><span class="STYLE4">|</span>
				
					<a href="admin/index.jsp" class="cl">管理员管理</a><span class="STYLE4">|</span>
				
					<a href="fee/index.jsp" class="cl">资费管理</a><span class="STYLE4">|</span>
				
					<a href="user/index.jsp" class="cl">用户管理</a><span class="STYLE4">|</span>
				
					<a href="account/index.jsp" class="cl">帐务管理</a><span class="STYLE4">|</span>
				
					<a href="reckon/index.jsp" class="cl">帐单管理</a><span class="STYLE4">|</span>
