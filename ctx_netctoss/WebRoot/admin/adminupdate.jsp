	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='../admin/adminupdate.jsp'  class=channel_title>管理员修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="adminform" method="post" action="adminupdate">
			<table border="0"  cellspacing='0' cellpadding='0' width="80%" height="100%">
			<%
			String ss = request.getParameter("id");
			ResultSet rs=JDBCUtil.getConnection().createStatement().executeQuery("select * from admins where id="+ss);
				rs.next();
			 %>
			<tr>
			...
			<tr>
				...
				<td align="left"><input type="text" name="loginpassword" value="XXXXXX" style="WIDTH:170px"/></td>
			</tr>
			<tr>
				<td align="right">确认口令：</td>
				<td align="left"><input type="text" name="passwordsec" value="XXXXXX" style="WIDTH:170px"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left">
							<input type="text" name="roleid" value="超级管理员" />
				</td>
			</tr>
			<tr>
