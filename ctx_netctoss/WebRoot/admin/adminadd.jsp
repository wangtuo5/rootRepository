	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0">
				<a href='../admin/adminadd.jsp'  class=channel_title>管理员增加</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="adminform" method="post" action="adminadd">
			...
			<tr>
				...
				<td align="left">
							<input type="text" name="roleid" value="超级管理员" style="WIDTH:170px"/>
				</td>
			</tr>
			<tr>
