	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="../images/sy_2_18.jpg" border="0"/>
				<a href='../admin/adminbrforupd.jsp'  class=channel_title>管理员修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<s:form action="adminask1" theme="simple">
		<!-- 查询的年份一本年前三年内的可以查询 -->
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>管理员ID</td><td>姓名</td><td>登录名</td><td>电话</td><td>电子邮件</td><td>授权日期</td><td>拥有的角色</td><td>修改操作</td>
				</tr>
						<% 
							String ask =null;
						...
						<td>
							<a href="adminupdate.jsp?id=<%=rs.getInt(1)%>">修改</a>
						</td>
						</tr>		
						<%	}
								}else{
